...
<html>
    ...
    <body onload="afficherpopup()">
        ...
        <section id="liste-utilisateurs">
            ...
            <div class="clear-fix">
                <form method="post" action="RechercherUtilisateur" class="formsearch">
                ...
                <button id="ajouterbtn" onclick="openFormAjouter()">Ajouter un utilisateur</button>
            </div>
            ...
            <%
                ...
                {
                    ResultSet result = ConnexionBD.executeSelectQuery("select * from user where admin = 0");
                    while(result.next())
                    {%>
                    <tr>
            ...
            <div class="form-popup" id="formAjouter">
                <center>
                    <form method="post" action="AjouterUtilisateur" class="form-container">
            ...
            <div class="form-popup" id="formModifier">
                <center>
                    <form method="post" action="ModifierUtilisateur" class="form-container">
                ...
                <script>
                    ...
                    function confirmpopup(matricule)
                    {
                        ...
                        if (confirmAction) 
                        {
                            ...
                            window.location.href = "/ipmanager/SupprimerUtilisateur?matricule=" + matricule;
                        } 
                    }
                </script>    
            </div>
