...
public class AjouterAdministrateur extends HttpServlet 
{
	private static final long serialVersionUID = 1L;

	public AjouterAdministrateur()
	{
		super();
	}
	...
	{	
		...
		{
			Logger.getLogger(AjouterAdministrateur.class.getName()).log(Level.SEVERE, null, ex);
		}
		
		if(info.equals("ok"))
		{
			User user = new User(Long.parseLong(matricule), prenom, nom, mdp, 1);
